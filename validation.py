...
def unigram_evaluation(lines):
    ...
    hashtag_list = HashtagClassifier().get_most_frequent_hashtag(HashtagClassifier().hashtag_classifier(lines))
    name_list = NameClassifier().get_most_frequent_names(NameClassifier().name_classifier(lines))
...
##################################################################################
    x_axis = [i for i in range(10, 100, 20)]
